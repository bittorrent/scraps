...
constexpr FixedEndian<T, endian>::FixedEndian(T value) noexcept
    : _value{detail::MaybeSwapByteOrder(value, std::integral_constant<bool, Endian::kNative != endian>{})}
{}

template <typename T, Endian endian>
constexpr FixedEndian<T, endian>::operator T() const noexcept {
    return detail::MaybeSwapByteOrder(_value, std::integral_constant<bool, Endian::kNative != endian>{});
}
