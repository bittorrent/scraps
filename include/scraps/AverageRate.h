...
/**
 * Container for storing timepoints and values for those timepoints. If a
 * maximum size is specified, the container will never exceed that size and
 * samples with lower time points will be removed.
 */
